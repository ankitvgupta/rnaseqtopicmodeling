...
#SBATCH -t 36:00:00              #Indicate duration using HH:MM:SS
#SBATCH -p general               #Partition to submit to

#SBATCH -o ./runctm_output_all.out            #File to which standard out will be written
#SBATCH -e ./runctm_error_all.err             #File to which standard err will be written
